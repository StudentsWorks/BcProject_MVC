...
<p>
Budeme používať najrozšírenejší webový server <a href = 'https://httpd.apache.org/' target="_blank">Apache</a>. Apache je open source softvér, dostupný zadarmo. Je rýchly, spoľahlivý a bezpečný. Na <a href = "https://www.wpbeginner.com/glossary/apache/" target = "_blank">Apache bežia 67% všetkých webových serverov na svete</a>. Tento server môže ľahko byť prispôsobený tak, aby vyhovoval potrebám mnohých rôznych prostredí. Väčšina poskytovateľov hostingu WordPress používa Apache ako svoj webový server. Pre tých, ktorí nevedia, <a href = 'https://kinsta.com/knowledgebase/what-is-wordpress/' target="_blank">WordPress</a> je najjednoduchší a najpopulárnejší spôsob vytvoriť vlastné webové stránky alebo blog. V skutočnosti, viac ako jeden zo štyroch webových stránok, ktoré navštívite, bol pravdepodobne vytvorený prostredníctvom WordPress.
Teraz poďme ďalej.</p>
